...
test_that("demuxEM Works as a report", {
	...
	cellhashR::CallAndGenerateReport(rawCountData = rawData, barcodeWhitelist = c('MS-11', 'MS-12'), reportFile = html, callFile = output, skipNormalizationQc = T, methods = c('demuxem', 'gmm_demux'), methodsForConsensus = c('demuxem'), rawFeatureMatrixH5 = h5File, minAllowableDoubletRateFilter = 0.4)
