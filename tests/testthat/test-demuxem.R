...
test_that("demuxEM Works as a report", {
	...
	cellhashR::CallAndGenerateReport(rawCountData = rawData, reportFile = html, callFile = output, skipNormalizationQc = T, methods = c('demuxem', 'gmm_demux'), methodsForConsensus = c('demuxem'), h5File = h5File)
